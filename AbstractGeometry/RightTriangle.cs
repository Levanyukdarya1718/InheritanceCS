...
namespace AbstractGeometry
{
	...
	{
		public RightTriangle(double triangleSide, double triangleBase, int startX, int startY, int lineWidth, Color color)
			: base(triangleSide, triangleBase, startX, startY, lineWidth, color) { }
